...
import com.ustc.dianping.common.*;
import com.ustc.dianping.model.SellerModel;
import com.ustc.dianping.request.PageQuery;
import com.ustc.dianping.request.SellerCreateReq;
import com.ustc.dianping.service.SellerService;
...
public class SellerController {
    ...
    @AdminPermission
    // @RequestBody 表示以json格式的字符串形式处理 sellerCreateReq
    // 默认使用key value键值对的形式接收 sellerCreateReq
