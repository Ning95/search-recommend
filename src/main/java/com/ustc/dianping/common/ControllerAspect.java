...
import com.ustc.dianping.controller.admin.AdminController;
...
public class ControllerAspect {
    ...
    @Around("execution(* com.ustc.dianping.controller.admin.*.*(..)) && @annotation(org.springframework.web.bind.annotation.RequestMapping)")
